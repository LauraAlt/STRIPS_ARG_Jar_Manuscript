...
figure1 <- ggplot(SE, aes(x = ordered(Primer, levels = levels_primer), y = Copy_Number, 
  ...
  labs(y = "Gene Copies/16S rRNA Copies") +
  ...
  theme(plot.title = element_text(),
        ...
        axis.title.y = element_text(family = "Times New Roman", size = 20),
...
ggsave("Figure1.tiff", plot = figure1,
       width = 10, height = 4.8, dpi = 500, units = c("in"))
